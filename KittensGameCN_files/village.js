dojo.declare("classes.managers.VillageManager", com.nuclearunicorn.core.TabManager, {
	...
	updateHappines: function(){
		...
		var unhappiness = ( this.getKittens()-10 ) * 1.5;
